...
<html x-data="{ darkMode: localStorage.getItem('darkMode') || 'false' }"
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php get_site_url(); ?>images/fav/favicon.ico">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php get_site_url(); ?>images/fav/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php get_site_url(); ?>images/fav/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php get_site_url(); ?>images/fav/favicon-16x16.png">
    <?php wp_head(); ?>
  </head>
  <body <?php body_class(); ?>>
